...
const API_URL = "https://ems-cws-test.vercel.app/api/projects";
  ...
  async function handleStatusChange(projectId, newStatus) {
    try {
      ...
      if (newStatus === "Completed") {
        apiUrl = `https://ems-cws-test.vercel.app/api/projects/${projectId}/complete`;
      } else if (newStatus === "Cancelled") {
        apiUrl = `https://ems-cws-test.vercel.app/api/projects/${projectId}/cancel`;
      }
