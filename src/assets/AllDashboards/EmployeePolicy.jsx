  ...
  const fetchEmployeeAcknowledgements = async () => {
    try {
      const res = await axios.get(
        `https://ems-cws-test.vercel.app/policy/employee-ack/${employeeId}`
      );
  ...
  const handleAcknowledge = async (policyId) => {
    try {
      ...
      const res = await axios.post(
        "https://ems-cws-test.vercel.app/policy/acknowledge",
        {
          policyId,
          employeeId,
          employeeName,
              ...
              {currentPolicies.map((policy) => (
                ...
                >       <td 
                  ...
                  <td style={tdStyle}>
                    {policy.image ? (
                      <a
                        href={`https://ems-cws-test.vercel.app/uploads/${policy.image}`}
                        download
                        target="_blank"
