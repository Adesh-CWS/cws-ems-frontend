...
function EventsAndHolidaysDashboard() {
  ...
  const handleDeleteAnnouncement = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://ems-cws-backend-9wgt.vercel.app/announcements/${id}`, {
...
useEffect(() => {
  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        const res = await axios.get("https://ems-cws-backend-9wgt.vercel.app/announcements/");
    ...
    const fetchEvents = async () => {
      try {
        ...
        const res = await axios.get(
          "https://ems-cws-backend-9wgt.vercel.app/events-for-employee",
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
  ...
  const handleDeleteEvent = async (id) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.delete(`https://ems-cws-backend-9wgt.vercel.app/events/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
